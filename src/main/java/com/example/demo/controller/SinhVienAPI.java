...
public class SinhVienAPI {
	...
	@RequestMapping(value = "/dssinhvien/getbyLHPID/{id}",method = RequestMethod.GET)
	public List<SinhVien> getAllSinhVienByLHPID(@PathVariable("id")Long id) {
		

		return sinhVienService.getAllSinhVienByLHPID(id);
	}
}
