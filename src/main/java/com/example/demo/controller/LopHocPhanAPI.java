...
public class LopHocPhanAPI {
	...
	@RequestMapping(value = "/dslophocphan/getByIDMHandIDGV/{idMH}/{idGV}")
	public List<LopHocPhan> getAllLHPByMHandGVID(@PathVariable("idMH") Long idMH,@PathVariable("idGV") Long idGV) {
		// TODO Auto-generated method stub
		return lopHocPhanService.getAllLHPByMHandGVID(idMH, idGV);
	}
}
