...
public interface SinhVienRepository extends CrudRepository<SinhVien, Long> {
	...
	@Query(value = "select * from sinhvien sv join dangkyhocphan dkhp on dkhp.sinhvien_id=sv.masinhvien where dkhp.lophocphan_id=:id",nativeQuery = true)
	List<SinhVien> getAllSinhVienByLHPID(Long id);
}
