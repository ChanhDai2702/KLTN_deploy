...
public interface LopHocPhanRepository extends CrudRepository<LopHocPhan, Long> {
	...
	@Query(value = "select * from lophocphan lhp where lhp.monhoc_id=:idMH and lhp.giangvien_id=:idGV",nativeQuery = true)
	List<LopHocPhan> getAllLHPByMHandGVID(Long idMH,Long idGV);
}
